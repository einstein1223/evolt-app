        ...
        <main class="flex-grow relative z-10">
            ...
            <section id="paket" class="py-24 bg-transparent">
                <div class="max-w-7xl mx-auto px-6">
                    ...
                    <!-- ✅ Stats — diperbaiki responsive mobile -->
                    <div class="bg-white/90 backdrop-blur-sm rounded-[2rem] p-6 sm:p-10 border border-gray-100 shadow-xl mb-20 reveal delay-100">
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-0 sm:gap-0 sm:divide-x divide-gray-200">
                            <!-- Stat 1 -->
                            <div class="text-center py-6 sm:py-0 border-b sm:border-b-0 border-gray-200">
                                <div class="text-4xl sm:text-5xl font-black text-lime-500 mb-2">+45%</div>
                                <p class="text-base sm:text-lg font-bold text-slate-900">Pertumbuhan EV</p>
                            </div>
                            <!-- Stat 2 -->
                            <div class="text-center py-6 sm:py-0 border-b sm:border-b-0 border-gray-200">
                                <div class="text-4xl sm:text-5xl font-black text-lime-500 mb-2">24/7</div>
                                <p class="text-base sm:text-lg font-bold text-slate-900">Passive Income</p>
                            </div>
                            <!-- Stat 3 -->
                            <div class="text-center py-6 sm:py-0">
                                <div class="text-4xl sm:text-5xl font-black text-lime-500 mb-2">0%</div>
                                <p class="text-base sm:text-lg font-bold text-slate-900">Biaya Franchise</p>
                            </div>
                        </div>
                    </div>
            ...
            <section id="kontak" class="py-24 bg-slate-900 text-white relative overflow-hidden rounded-t-[4rem] z-20">
                ...
                <div class="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <!-- ✅ Hanya 3 kartu kontak, tanpa form Kirim Pesan -->
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 reveal">
                        <div class="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl text-center hover:bg-white/10 transition group">
                            ...
                            <p class="text-gray-400">{{ contactData.phone }}</p>
                        </div>
                        <div class="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl text-center hover:bg-white/10 transition group">
                            <div class="w-16 h-16 bg-[#00C853]/20 text-[#00C853] rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6 group-hover:scale-110 transition">📧</div>
                            <h3 class="font-bold text-xl mb-2">Email</h3>
                            <p class="text-gray-400">{{ contactData.email }}</p>
                        </div>
                        <div class="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl text-center hover:bg-white/10 transition group">
                            <div class="w-16 h-16 bg-[#00C853]/20 text-[#00C853] rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6 group-hover:scale-110 transition">📍</div>
                            <h3 class="font-bold text-xl mb-2">Kantor</h3>
                            <p class="text-gray-400 whitespace-pre-line text-sm">{{ contactData.address }}</p>
                        </div>
                    </div>

                    <!-- CTA WhatsApp sebagai pengganti form -->
                    <div class="mt-12 text-center reveal">
                        <a :href="waLink('Halo E-VOLT, saya ingin bertanya lebih lanjut.')"
                            class="inline-flex items-center gap-3 bg-[#00C853] text-white font-bold px-10 py-4 rounded-2xl hover:bg-[#00a844] transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-green-900/20 text-lg">
