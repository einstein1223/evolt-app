      ...
      <section class="py-16 lg:py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <!-- CARD 1: UNTUK DRIVER -->
            <div class="bg-[#00C853] p-8 sm:p-10 rounded-3xl shadow-xl text-white relative overflow-hidden flex flex-col justify-center group transition hover:shadow-2xl hover:-translate-y-1">
                <div class="absolute top-0 right-0 -mr-8 -mt-8 w-40 h-40 bg-white opacity-10 rounded-full group-hover:scale-110 transition-transform duration-500"></div>
                <div class="relative z-10">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="bg-white/20 p-2 rounded-lg"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg></span>
                    ...
                    Akses ribuan stasiun pengisian daya dengan satu aplikasi. Hemat waktu, biaya transparan, dan bebas antri.
                    </p>
                    <Link :href="route('register')" class="inline-block bg-white text-[#00C853] font-bold px-8 py-4 rounded-xl shadow-md hover:bg-lime-50 active:scale-95 transition duration-300 w-full sm:w-auto text-center">
                        Daftar Gratis
                    </Link>
                </div>
            </div>
            ...
            <div class="bg-gray-900 p-8 sm:p-10 rounded-3xl shadow-xl text-white relative overflow-hidden flex flex-col justify-center group transition hover:shadow-2xl hover:-translate-y-1">
                <div class="absolute bottom-0 left-0 -ml-8 -mb-8 w-40 h-40 bg-[#CCFF00] opacity-10 rounded-full group-hover:scale-110 transition-transform duration-500"></div>
                <div class="relative z-10">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="bg-white/10 p-2 rounded-lg"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#CCFF00]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg></span>
                        <span class="uppercase text-sm font-bold tracking-wider text-gray-400">Untuk Pemilik Rumah</span>
                    </div>
                    <h3 class="text-3xl font-bold mb-4 leading-tight">Punya Charger Nganggur? <span class="text-[#CCFF00]">Jadikan Cuan.</span></h3>
                    <p class="mb-8 text-gray-400 text-base leading-relaxed">
                    Sewakan listrik rumah Anda ke sesama pengguna EV. Jadilah bagian dari jaringan energi komunitas terbesar.
                    </p>
                    <Link :href="route('become.host')" class="inline-block bg-[#CCFF00] text-black font-bold px-8 py-4 rounded-xl shadow-md hover:bg-[#b3e600] active:scale-95 transition duration-300 w-full sm:w-auto text-center">
                        Jadi Mitra Host
                    </Link>
                </div>
            </div>
