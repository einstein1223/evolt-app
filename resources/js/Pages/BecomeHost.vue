        ...
        <main class="flex-grow pt-24 pb-10 px-4">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="text-center mb-10">
                    <span
                        class="bg-orange-100 text-orange-600 px-4 py-1.5 rounded-full text-sm font-bold tracking-wide uppercase">Program
                        Mitra</span>
                    <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 mt-4">Jadikan Rumahmu <br><span
                            class="text-[#00C853]">Stasiun Pengisian</span></h1>
                    <p class="text-gray-500 mt-3 text-lg">Bantu komunitas EV dan dapatkan penghasilan tambahan dari
                        charger nganggur di rumah Anda.</p>
                </div>
                    ...
                    <form @submit.prevent="submit" class="p-8 md:p-10 space-y-8">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                                <span
                                    class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center text-sm">1</span>
                                Informasi Lokasi
                            </h3>
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                                <span
                                    class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center text-sm">2</span>
                                Spesifikasi Alat
                            </h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Daya Listrik
                                        (Watt/kW)</label>
                                    <div class="relative">
                                ...
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Sewa per kWh /
                                        Jam</label>
                                    <div class="relative">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                                <span
                                    class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center text-sm">3</span>
                                Foto Lokasi
                            </h3>
                            <div
                        ...
                        <div class="bg-orange-50 p-4 rounded-xl border border-orange-100">
                            <div class="flex items-start">
                                <input id="terms" v-model="form.agreeTerms" type="checkbox"
                                    class="mt-1 w-4 h-4 text-[#00C853] border-gray-300 rounded focus:ring-[#00C853]">
                                <label for="terms" class="ml-3 text-sm text-gray-600">
                                    Saya menyatakan bahwa instalasi listrik di rumah saya aman dan saya menyetujui
                                    <a href="#" class="text-orange-600 font-bold hover:underline">Perjanjian Kemitraan
                                        Host</a>.
